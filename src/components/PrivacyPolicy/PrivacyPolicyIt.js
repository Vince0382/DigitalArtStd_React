...
const PrivacyPolicyIt = props => (
    <div>
        <p>Data di entrata in vigore: October 08, 2019</p>


        <p>DigitalArtStd ("noi" o "nostro") gestisce il https://digitalartstd.com sito web (in appresso il "Servizio").</p>

        <p>Questa pagina vi informa delle nostre politiche riguardanti la raccolta, l'uso e la divulgazione dei dati personali quando usate il nostro Servizio e le scelte che avete associato a quei dati. Our Privacy Policy for DigitalArtStd is created with the help of the <a href="https://www.privacypolicies.com/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>

        <p>Utilizziamo i vostri dati per fornire e migliorare il Servizio. Utilizzando il Servizio, accettate la raccolta e l'utilizzo delle informazioni in conformità con questa informativa. Se non diversamente definito nella presente Informativa sulla privacy, i termini utilizzati nella presente Informativa hanno la stessa valenza dei nostri Termini e condizioni, accessibili da https://digitalartstd.com</p>

        <h2>Definizioni</h2>
        <ul>
            <li>
                <p><strong>Servizio</strong></p>
                        <p>Il Servizio è il sito https://digitalartstd.com gestito da DigitalArtStd</p>
                    </li>
            <li>
        ...
        <ul>
            <li>Indirizzo email</li>    <li>Nome e cognome</li>    <li>Numero di telefono</li>        <li>Cookie e dati di utilizzo</li>
        </ul>
        ...
        <h2>Uso dei dati</h2> 
        <p>DigitalArtStd utilizza i dati raccolti per vari scopi:</p>    
        <ul>
        ...
        <ul>
                <li>Tramite e-mail: DigitalArtStda@gmail.com</li>
                    <li>Visitando questa pagina sul nostro sito web: https://DigitalArtStda/#contact</li>
            
                <li>Per telefono: +39 3313056476</li>
                </ul>
    </div>
);
